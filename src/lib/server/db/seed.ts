...
if (process.argv[1] === import.meta.path || process.argv[1] === new URL(import.meta.url).pathname) {
	...
	const playlists = [
		{
			name: 'Afrobeat Vibes',
			description: 'Groovy rhythms from West Africa',
			song_count: 25,
		...
		},
		{
			...
			image_url: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400',
			source: 'youtube',
			genre: JSON.stringify(['Rock', 'Classic Rock']),
		...
		},
		{
			...
			source: 'apple',
			genre: JSON.stringify(['Jazz', 'Lounge']),
		...
		},
		{
			...
			description: 'Must-hear hip-hop tracks',
			song_count: 35,
			image_url: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400',
			source: 'youtube',
		...
		{
			name: 'Country Roads',
			description: 'Feel-good country tunes',
			song_count: 28,
		...
		{
			name: 'Blues Legends',
			description: 'Classic blues guitar',
			song_count: 18,
		...
		{
			name: 'Reggae Rhythms',
			description: 'Island vibes and chill beats',
			song_count: 32,
			image_url: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?w=400',
			source: 'apple',
		...
		},
		{
			...
			description: 'Fresh indie artists',
			song_count: 27,
