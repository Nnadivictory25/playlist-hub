...
<section class="pt-20 min-h-[65vh] flex items-center justify-center">
    <Card.Root class="-my-4 w-full max-w-sm">
        ...
        <Card.Content>
         <Button onclick={signInWithGoogle} variant="outline" class="w-full cursor-pointer" disabled={isLoading}>
